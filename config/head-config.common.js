...
module.exports = {
  link: [
    ...
    { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/assets/icon/favicon-48x48.png' },
    { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icon/favicon-48x48.png' },
    { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/assets/icon/favicon-48x48.png' },
